...
struct SyscallHandler {
    uint8_t *mem = 0;       // direct pointer to start of guest memory in host memory //TODO rv64
    uint64_t mem_offset;    // start address of the memory as mapped into the address space
    ...
    void init(uint8_t *host_memory_pointer, uint64_t mem_start_address, uint64_t heap_pointer_address) { //TODO rv64 correct?
