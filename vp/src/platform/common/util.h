...
struct BlankDevice : public sc_core::sc_module {
    ...
    BlankDevice(sc_core::sc_module_name, unsigned size)
...
/* Simple UART/terminal, e.g. this implementation matches the HiFive1 board write address and is already sufficient to print characters in Zephyr OS examples. */
